            ...
            <div className='about-me__content'>
                <div className='bio'>
                    <div className=''>
                        ...
                        <p>
                            I pride myself on being prompt, organized, asking quality questions, and working well in a team. I have pronounced experience with <span className='span-color'>Javascript, React, Redux, Node.js, Python, and Flask</span> .
                        </p>
                    </div>
                </div>
