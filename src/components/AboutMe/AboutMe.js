            ...
            <div className='about-me__content'>
                <div className='bio'>
                    <div className=''>
                        ...
                        <p>
                            Formerly I was an <span className='span-color'>award winning Chef with over 13 years of experience in the industry</span>. I've managed some of the most renowned restaurants in California, and I was an integral part of <span className='span-color'>Team USA for the 2019 Bocuse d'Or</span> .
                        </p>
                        <p>
